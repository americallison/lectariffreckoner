      ...
      <form>
...

        {
          (presentmonth - monthss.indexOf(vendingMonth) < 0) && (vendingYear == presentDate.getFullYear()) ? (
            <div className="fixed top-60-md top-50 left-0 w-full flex items-center justify-center z-10">
              <div className="p-4 bg-white rounded-lg border-4 border-b-4 border-red-200 shadow-lg">
